...
public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)// Disable CSRF since we use JWTs (stateless sessions)
         ...
         .requestMatchers("/api/admin/**", "/api/admin/details", "api/mentors/add-mentor","/api/mentors/update/{employeeId}","/api/mentors/delete/{employeeId}","/api/batches/**").hasAuthority("ROLE_ADMIN")
